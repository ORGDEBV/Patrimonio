...
var Patrimonio = {
    ...
    bindEvents: function() {
        ...
        this.menulinks.on('click',function(e) {
            ...
            ///////////*****QUITA EL REDIRECCIONAMIENTO DEL MENU***************///////////
            if(menuitemLink.next().children().is('li')) {
                e.preventDefault();
            }
            else {
                $this.menuButton.removeClass('active-menu');
    ...
    saveMenuState: function() {
        $.cookie('restaurar_menu', this.expandedMenuitems.join(','), {path:'/'});
    },
    
    clearMenuState: function() {
        $.removeCookie('restaurar_menu', {path:'/'});
    },
    
    restaurarMenu: function() {
        var menucookie = $.cookie('restaurar_menu');
        if(menucookie) {
